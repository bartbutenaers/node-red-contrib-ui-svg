...
:warning: ***Version 2.0.0 will contain a breaking change for events!!!  See [here](https://github.com/bartbutenaers/node-red-contrib-ui-svg/wiki/Breaking-change-version-2.0.0) for more information.***
